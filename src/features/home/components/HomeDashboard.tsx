...
import { toHexChainId, getHexNetworkName } from "@/lib/keychain-utils";
import { DEFAULT_SORT_KEY, SORT_FIELDS } from "@/features/home/utils/sorting";
...
export const HomeDashboard = () => {
  ...
  const networkName = hexChainId ? getHexNetworkName(hexChainId) : "Unknown";
