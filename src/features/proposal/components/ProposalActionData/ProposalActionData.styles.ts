...
export const WarningContainer = styled(Card)<{
  ...
  background-color: ${({ theme, $error, $warning }) =>
    ($error && theme.danger.step3) || ($warning && theme.warning.step3) || 'transparent'};
  border-color: ${({ theme, $error, $warning }) =>
    ($error && theme.danger.step7) || ($warning && theme.warning.step7) || 'transparent'};
`;
...
export const StyledParXs = styled(ParXs)<{
  ...
  color: ${({ theme, $error, $warning }) =>
    ($error && theme.danger.step12) || ($warning && theme.warning.step12) || 'inherit'};
`;
