...
import { FormSegment, Link, ParSm, WrappedTextArea } from "@/lib/ui";
import { INFO_COPY } from "@/lib/utils";

import { TextAreaSection } from "./FormLayouts";
import { transformShamans, validateShamanData } from "@/utils/summonCommon";
import { FORM_KEYS } from "@/utils/summonFormKeys";
...
export const ShamanSegment = ({ formDisabled }: { formDisabled: boolean }) => {
  ...
  return (
    <FormSegment
      ...
      formArea={
        <TextAreaSection>
          <Link className="link" href="https://moloch.daohaus.club/tools/shaman">
            How to add a Shaman
          </Link>
