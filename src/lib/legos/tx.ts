...
import { buildMultiCallTX } from '@/lib/tx-builder';
import { MaxUint256 } from '@/lib/utils';
import { ProposalTypeIds } from '@/lib/utils';
    ...
    actions: [
      {
        ...
        method: 'mintLoot',
        args: [
          { type: 'nestedArray', args: ['.formValues.memberAddress'] },
          { type: 'nestedArray', args: ['.formValues.memberShares'] },
        ],
      },
      {
        contract: CONTRACT.CURRENT_DAO,
