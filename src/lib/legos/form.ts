import { SUMMON_COPY } from '@/lib/utils';
import { MolochFormLego } from '@/lib/legos/fields/fieldConfig';
...
export const PROPOSAL_FORMS: Record<string, MolochFormLego> = {
  ...
  ISSUE: {
    ...
    fields: [
      ...
      { ...FIELD.TO_WEI, label: 'Voting Token Requested', id: 'sharesRequested' },
      { ...FIELD.TO_WEI, label: 'Non-Voting Token Requested', id: 'lootRequested' },
      ...PROPOSAL_SETTINGS_FIELDS,
    ],
  },
  ADD_SHAMAN: {
  ...
  TRANSFER_ERC20: {
    ...
    tx: TX.ISSUE_ERC20,
    requiredFields: { title: true, description: true, payment: true, recipient: true },
    fields: [
      FIELD.TITLE,
      FIELD.DESCRIPTION,
      FIELD.LINK,
      { id: 'recipient', type: 'input', label: 'Recipient', info: 'Address to receive the tokens', placeholder: '0x...' },
      FIELD.REQUEST_TOKEN,
      ...PROPOSAL_SETTINGS_FIELDS,
    ],
  },
  ...
  UPDATE_GOV_SETTINGS: {
    ...
    requiredFields: {
      title: true, description: true, votingPeriod: true, gracePeriod: true,
      quorum: true, minRetention: true, sponsorThreshold: true, newOffering: true,
    },
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
      {
        id: 'timing', type: 'formSegment', title: 'Proposal Timing',
        description: 'Update your timing for Voting and Grace periods.',
        fields: [{
          id: 'timingSplit', type: 'splitColumn',
          rows: [{ rowId: 'timingRows',
            left: { id: 'votingPeriod', type: 'timePicker', label: 'Voting Period', info: SUMMON_COPY.VOTING_PERIOD },
            right: { id: 'gracePeriod', type: 'timePicker', label: 'Grace Period', info: SUMMON_COPY.GRACE_PERIOD },
          }],
        }],
      },
      {
        id: 'advanced', type: 'formSegment', title: 'Advanced Governance',
        description: 'Modify some advanced governance features.',
        fields: [{
          id: 'advancedSplit', type: 'splitColumn',
          rows: [
            { rowId: 'row1',
              left: { id: 'quorum', type: 'input', expectType: 'percent', label: 'Quorum %', placeholder: '20', info: SUMMON_COPY.QUORUM },
              right: { id: 'minRetention', type: 'input', label: 'Min Retention', expectType: 'percent', placeholder: '66', info: SUMMON_COPY.MIN_RETENTION },
            },
            { rowId: 'row2',
              left: { id: 'sponsorThreshold', type: 'toWeiInput', expectType: 'number', label: 'Sponsor Threshold', placeholder: '1', info: SUMMON_COPY.SPONSOR_THRESHOLD },
              right: { id: 'newOffering', type: 'toWeiInput', label: 'New Offering', expectType: 'number', placeholder: '0', info: SUMMON_COPY.NEW_OFFERING },
            },
          ],
        }],
      },
  ...
  TOKEN_SETTINGS: {
    ...
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
      {
        id: 'tokenSettings', type: 'formSegment', title: 'DAO Tokens',
        description: 'Update Token Transferability',
        fields: [{
          id: 'split', type: 'splitColumn',
          rows: [{ rowId: 'row1',
            left: { id: 'vStake', type: 'switch', label: 'Voting Token', info: SUMMON_COPY.STAKE_TRANSFER, switches: [{ id: 'vStake', fieldLabel: { off: 'Transferable', on: 'Not Transferable' } }] },
            right: { id: 'nvStake', type: 'switch', label: 'Non-Voting Token', info: SUMMON_COPY.NV_STAKE_TRANSFER, switches: [{ id: 'nvStake', fieldLabel: { off: 'Transferable', on: 'Not Transferable' } }] },
          }],
        }],
      },
      ...PROPOSAL_SETTINGS_FIELDS,
  ...
  TOKENS_FOR_SHARES: {
    ...
    requiredFields: { title: true, description: true, sharesRequested: true, lootRequested: true },
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
      { ...FIELD.TO_WEI, label: 'Voting Token Requested', id: 'sharesRequested' },
      { ...FIELD.TO_WEI, label: 'Non-Voting Token Requested', id: 'lootRequested' },
  ...
  GUILDKICK: {
    ...
    tx: TX.GUILDKICK,
    requiredFields: { title: true, memberAddress: true },
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
      { id: 'memberAddress', type: 'selectApplicant', label: 'Member', daoMemberOnly: true },
      ...PROPOSAL_SETTINGS_FIELDS,
    ],
  },
  WALLETCONNECT: {
    ...
    tx: TX.WALLETCONNECT,
    requiredFields: { title: true, walletConnectLink: true },
    fields: [FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK, FIELD.WALLETCONNECT_LINKER, ...PROPOSAL_SETTINGS_FIELDS],
  },
  MULTICALL_BUILDER: {
    id: 'MULTICALL',
    ...
    fields: [
      { id: 'details', type: 'formSegment', collapsible: true, defaultOpen: true, title: 'Proposal Overview',
        fields: [FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK, ...PROPOSAL_SETTINGS_FIELDS] },
      { id: 'multisendActions', type: 'multisendActions' },
    ],
  },
  ...
  ADD_SIGNER_TO_SIDECAR: {
    ...
    description: 'Create a proposal to add a signer to a DAO Safe',
    tx: TX.ADD_SIGNER_TO_SIDECAR,
    requiredFields: { title: true, description: true, signer: true, threshold: true },
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK, FIELD.SAFE_SELECT,
      { id: 'signer', type: 'input', label: 'Signer', info: 'Signer Address', expectType: 'ethAddress', placeholder: '0x...' },
      { id: 'threshold', type: 'input', label: 'Threshold (1 for 1/1 signers)', expectType: 'number', placeholder: '1' },
      ...PROPOSAL_SETTINGS_FIELDS,
    ],
  },
  ISSUE_SHARES: {
    ...
    tx: TX.ISSUE_SHARES,
    requiredFields: { title: true, description: true, addressesAndAmounts: true },
    fields: [FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK, FIELD.ADDRESSES_AMOUNTS, ...PROPOSAL_SETTINGS_FIELDS],
  },
};
...
export const TABULA_FORMS: Record<string, MolochFormLego> = {
  CREATE_PUBLICATION: {
    ...
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
      {
        id: 'pubData', type: 'formSegment', title: 'Publication Data',
        description: 'Some information about your publication.',
        fields: [
          { id: 'pubName', type: 'input', label: 'Publication Name', placeholder: 'Name' },
          { id: 'tags', type: 'csInput', label: 'Publication Name', placeholder: 'comma, separated, tags', itemNoun: { singular: 'tag', plural: 'tags' } },
          { id: 'pubDescription', type: 'textarea', label: 'Publication Description', placeholder: 'Description' },
          { id: 'pubImage', type: 'input', label: 'Publication Image', placeholder: 'Image URL', expectType: 'url' },
        ],
      },
      ...PROPOSAL_SETTINGS_FIELDS,
    ],
...
export const COMMON_FORMS: Record<string, MolochFormLego> = {
  METADATA_SETTINGS: {
    ...
    fields: [
      ...
      { ...FIELD.DESCRIPTION, id: 'long_description', label: 'Long Description' },
      { ...FIELD.LINK, id: 'icon', label: 'Icon' },
      {
        id: 'links', type: 'formSegment', title: 'Add links to important content for your DAO',
        fields: [
  ...
  UPDATE_SHAMAN: {
    ...
    subtitle: 'Shaman Proposal',
    requiredFields: { title: true, description: true, shamanAddress: true, shamanPermission: true },
    tx: TX.ADD_SHAMAN,
    fields: [
      FIELD.TITLE, FIELD.DESCRIPTION, FIELD.LINK,
  ...
  MANAGE_DELEGATE: {
    ...
    requiredFields: { delegatingTo: true },
  ...
  MANAGE_TOKENS: {
    ...
    requiredFields: { transferTokens: true, paymentTokenAddress: true, recipientAddress: true },
  ...
  RAGEQUIT: {
    ...
    subtitle: 'Members',
    fields: [
      { id: 'tokenAmounts', type: 'formSegment', title: 'Step 1. Select voting and/or non-voting tokens to ragequit',
        fields: [{ id: 'sharesToBurn', type: 'ragequitToken' }, { id: 'lootToBurn', type: 'ragequitToken' }] },
      { id: 'tokenAddresses', type: 'formSegment', title: 'Step 2. Select treasury tokens you want to receive in exchange for your DAO tokens',
        fields: [{ id: 'tokens', type: 'ragequitTokenList' }] },
      { id: 'checkRender', type: 'checkRender', gateLabel: 'Ragequit to different address (optional)',
        components: [{ id: 'to', type: 'input', label: 'Address to send funds', expectType: 'ethAddress', placeholder: '0x...' }] },
    ],
    tx: TX.RAGEQUIT,
  },
  ADD_SAFE: {
    ...
    requiredFields: { name: true },
    tx: TX.ADD_SAFE,
    fields: [{ id: 'name', type: 'input', label: 'Safe Name', placeholder: 'Enter name' }],
