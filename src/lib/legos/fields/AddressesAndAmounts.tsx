...
import { Buildable, Field, WrappedTextArea } from '@/lib/ui';
import {
...
export const AddressesAndAmounts = (props: Buildable<Field>) => {
  ...
  const validFieldMsg = useMemo(() => {
    if (multipleSharesField === '' || !multipleSharesField) return undefined;
    if (validateAddressesAndAmountsData(multipleSharesField)) return 'Formatting is valid.';
    return undefined;
  }, [multipleSharesField]);
